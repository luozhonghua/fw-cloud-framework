...
import com.st.fox.admin.service.bean.sysUser;
...
public class LoginController extends CommonController{
	...
	public String setInfo(@RequestBody Map<String,Object> params){ //@RequestParam(value="oldpwd") String oldpwd, @RequestParam(value = "newpwd") String newpwd
    //public String setInfo(@RequestBody(required=false) sysUser record, HttpServletRequest request){
      // System.out.println( request.getAttribute("oldpwd"));
      // return sysAdminUserService.setInfo(this.getCurrentUser(),record.getOldpass(),record.getNewpass());
        System.out.println(params.get("oldpwd").toString());
        System.out.println(params.get("newpwd").toString());
