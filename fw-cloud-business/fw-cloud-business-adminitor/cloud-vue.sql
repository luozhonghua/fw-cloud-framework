...
CREATE TABLE `sys_admin_rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8  COMMENT='规则表';
...
CREATE TABLE `sys_admin_structure` (
  ...
  `status` tinyint(3) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8  COMMENT='结构部门表';
...
INSERT INTO `sys_admin_user` VALUES ('3', '用户AAAA', 'e10adc3949ba59abbe56e057f20f883e', '', '1487217060', '用户A', '5', '20', '1');
